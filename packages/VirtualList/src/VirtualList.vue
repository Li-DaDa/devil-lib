<template>
  <div class="dv-virtual-list" ref="rootDom" @scroll.passive="scrollHandler">
    <div class="dv-virtual-list_container" ref="containerDom" :style="{ height: containerHeight + 'px' }">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const getIndex = (scrollTop: number) => {
      ...
      pos.value[0] = Math.max(0, start - (props.topDistance as number))
...
.md-virtual-list_animate {
  overflow: hidden;
}
.md-virtual-list_item {
  &.md-enter-item {
    transition: all 0.4s;
  }
}
